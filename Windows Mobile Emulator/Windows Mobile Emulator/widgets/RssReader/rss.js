...
function Localize() {
    ...
    title.innerHTML = 'My RSS Reader';
    
    var title = document.getElementsByTagName('p')[0];
    title.innerHTML = 'This is my RSS Reader.';
}